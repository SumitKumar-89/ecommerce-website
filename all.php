        ...
        <div class="container-fluid" id="content">
            <div class="col-md-12">
                <div class="jumbotron">
                    ...
                    <a href="all.php"><img src="img1/allmain.jpg" alt=""  width="103%" , hiegh="40%"></a>
                        <div class="content">
                        <h1 align="center">Welcome to Our Sarvesu  Electronics  and Fashion Store!</h1>
                    
                </div>
                <div class="content1">
                        <h2 align="center">No need to hunt around, we have all in one place.</h2>
...
<!-- second category is jeans-->
        ...
        <div class="row text-center" id="shoes">
            ...
            </div> <hr><h2 align="center">Electronics Products</h2><hr>
